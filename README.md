...
* To achieve global access to variables and functions, Redux Toolkit was implemented. However, to avoid prop drilling within lists iterated by the map() method, local Context was utilized.
